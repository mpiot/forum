...
abstract class RoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->executeRoleCommand($this->userManager, $this->io, $email, $role);
    ...
    abstract protected function executeRoleCommand(UserManager $userManager, SymfonyStyle $io, $email, $role);
}
