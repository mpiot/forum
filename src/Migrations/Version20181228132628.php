 ...
 */
final class Version20181228132628 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1D23588C1 FOREIGN KEY (last_active_thread_id) REFERENCES thread (id)');
    }
